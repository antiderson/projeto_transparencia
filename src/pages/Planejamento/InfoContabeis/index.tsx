...
const InfoContabeis: React.FC = () => {
  const [results, setResults] = useState<InfoContabeisProps[]>([]);
  ...
  const carregaInfoContabeis = async () => {
    setLoading(true);
    api
    ...
    <Container>
      ...
      <Body>
        ...
        <Content>
          ...
          <ContainerRetract title="Buscar Infomarções Contábeis">
            <Form ref={formRef} onSubmit={carregaInfoContabeis}>
              <ContainerForm>
                <LabelContainer>
                  <p>Entidade:</p>
